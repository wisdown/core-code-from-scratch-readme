...
/*  The buildArray function builds an array of unique random numbers containing the number 
    ...
    La función buildArray crea una matriz de números aleatorios únicos que contienen el número
     de elementos en función del número que se le pasa. El parámetro sortOrder determina
     si ordenar la matriz en orden ascendente o descendente.
